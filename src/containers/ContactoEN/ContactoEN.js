...
class ContactoEN extends Component {
                    ...
                    <div className="container">
                        <div className="row d-flex mb-5 contact-info">
                            ...
                            <div className="col-md-4">
                                <p><span>Address:</span> Marcelo T. de Alvear 636 piso 9°</p>
                            </div>
                            <div className="col-md-4">
                                <p><span>Phone:</span> <a href="tel://1234567920">+54 11 4311 7999</a></p>
                            </div>
                            <div className="col-md-4">
                        ...
                        <div className="row block-9">
                            <div className="col-lg-6 order-md-last d-flex">
                                <form action="#" className="bg-light p-5 contact-form">
                                    ...
                                    <div className="form-group">
                                        <input type="text" className="form-control" placeholder="Affair"/>
                                    </div>
                                    <div className="form-group">
