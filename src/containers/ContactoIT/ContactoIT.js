...
class ContactoIT extends Component {
                    ...
                    <div className="container">
                        <div className="row d-flex mb-5 contact-info">
                            <div className="col-md-12 mb-4">
                                <h2 className="h3">Informazioni di contatto</h2>
                            </div>
                            <div className="w-100"></div>
                            <div className="col-md-4">
                                <p><span>Indirizzo:</span> Marcelo T. de Alvear 636 piso 9°</p>
                            </div>
                            <div className="col-md-4">
                                <p><span>Telefono:</span> <a href="tel://1234567920">+54 11 4311 7999</a></p>
                            </div>
                            <div className="col-md-4">
                                <p><span>E-mail:</span> <a href="mailto:info@arancedogalli.com.ar">info@arancedogalli.com.ar</a></p>
                            </div>
                        </div>
                        <div className="row block-9">
                            <div className="col-lg-6 order-md-last d-flex">
                                <form action="#" className="bg-light p-5 contact-form">
                                    ...
                                    <div className="form-group">
                                        <input type="text" className="form-control" placeholder="Affari"/>
                                    </div>
                                    <div className="form-group">
                                        <textarea name="" id="" cols="30" rows="7" className="form-control" placeholder="Messaggio"></textarea>
                                    </div>
                                    <div className="form-group">
                                        <input type="submit" value="Invia Messaggio" className="btn btn-primary py-3 px-5"/>
                                    </div>
                                </form>
                            </div>
                            <div className="col-lg-6 d-flex">
                                <div id="wrapper-9cd199b9cc5410cd3b1ad21cab2e54d3">
                                    ...
                                    <a href="https://1map.com/en/map-embed?embed_id=152295"></a>
                                </div>
                            </div>
                        </div>
                    </div>
